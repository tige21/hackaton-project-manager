...
const docTemplate = `
{
  ...
  "paths": {
    ...
    "/integration/v1/users/{id}/competency": {
      "put": {
        "security": [
          {
            "bearerAuth": []
        ...
        "summary": "редактирование компетенции",
        "tags": [
          "Users Integration"
        ],
        "parameters": [
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/UpdateCompetency"
              }
            }
          }
        },
  ...
  "components": {
    ...
    "schemas": {
      ...
      "UpdateCompetency": {
        "type": "object",
        "description": "модель изменения компетенций",
        "properties": {
          "type": {
            "type": "string",
          ...
          "point": {
            "type": "integer",
            "description": "количество компетенции",
            "example": 15,
            "nullable": false
          }
        }
      ...
      "Competency": {
        "type": "object",
        "description": "модель уровня компетенций",
        "properties": {
          "competencyLevel": {
            "type": "integer",
            "description": "количество компетенции",
