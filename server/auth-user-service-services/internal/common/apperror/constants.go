...
var (
	...
	ErrInvalidCompetencyType = errors.New("invalid competency type")
	ErrCompetencyPointIsLess = errors.New("competency point is less than expected")
	ErrCompetencyPointIsMore = errors.New("competency point is more than expected")

	ErrCompetencyPointIsLessThenLowLimit   = errors.New("new competency level cannot be less than 100")
	ErrCompetencyPointIsHigherThenMaxLimit = errors.New("new competency level cannot be higher than 100")
	ErrInvalidCompetency                   = errors.New("conflict competency")
